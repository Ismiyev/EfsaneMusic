            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/ASOmusicbot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/ASOmusic_asistant"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/ASOmusicbot"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/ASOresmi"
                    )
                ]
         ...
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/ASOsonzirve"
                    )
                ],
                [
                    InlineKeyboardButton(
